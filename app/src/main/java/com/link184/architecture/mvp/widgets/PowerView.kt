package com.link184.architecture.mvp.widgets
...
import com.link184.architecture.mvp.R
...
class PowerView(
    ...
    init {
        ...
        val viewState = LoadingState.resolveState(this, containerOrder, withProgressBar, layoutAnimationId, disableLayoutAnimation, withSwipeRefreshLayout, withRecyclerView)
